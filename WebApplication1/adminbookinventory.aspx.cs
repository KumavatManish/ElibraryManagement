...
namespace WebApplication1
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // this databind() refresh the database 
            GridView1.DataBind();
        }
  ...
  //-------------------- user defined functions------------------------------
        ...
        // Dropdown list for Author and Publisher
        ...
        void addNewBook()
        {
            try
            {
              ...
              //remove , from genres
                ...
                // display book image  ( This default image will display if no image pass..)  
                ...
                // This file path will store into database
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl" +
                    "(book_id,book_name,genre,author_name,publisher_name,publisher_date,language,edition,book_cost,no_of_pages," +
                    "book_description,actual_stock,current_stock,book_img_link) " +
                    "values(@book_id,@book_name,@genre,@author_name,@publisher_name,@publisher_date,@language,@edition,@book_cost,@no_of_pages," +
                ...
                //here we store image file page into database
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl set book_name=@book_name, genre=@genre," +
                        " author_name=@author_name, publisher_name=@publisher_name, publisher_date=@publisher_date, " +
        ...
        // delete button will execute this function
        void deleteBookByID()
        {
            if (checkIfBookExists())
            {
